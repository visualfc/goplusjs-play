...
func init() {
	ixgo.RegisterPackageLazy("github.com/google/uuid", func() *ixgo.Package {
		return &ixgo.Package{
			Name: "uuid",
			...
			TypedConsts: map[string]ixgo.TypedConst{
				"Future":    {Typ: reflect.TypeOf(q.Future), Value: constant.MakeInt64(int64(q.Future))},
				"Group":     {Typ: reflect.TypeOf(q.Group), Value: constant.MakeInt64(int64(q.Group))},
				"Invalid":   {Typ: reflect.TypeOf(q.Invalid), Value: constant.MakeInt64(int64(q.Invalid))},
				"Microsoft": {Typ: reflect.TypeOf(q.Microsoft), Value: constant.MakeInt64(int64(q.Microsoft))},
				"Org":       {Typ: reflect.TypeOf(q.Org), Value: constant.MakeInt64(int64(q.Org))},
				"Person":    {Typ: reflect.TypeOf(q.Person), Value: constant.MakeInt64(int64(q.Person))},
				"RFC4122":   {Typ: reflect.TypeOf(q.RFC4122), Value: constant.MakeInt64(int64(q.RFC4122))},
				"Reserved":  {Typ: reflect.TypeOf(q.Reserved), Value: constant.MakeInt64(int64(q.Reserved))},
			},
